package org.seaboxdata.platform.controller.repository;
...
import org.seaboxdata.ext.cluster.SlaveServerCodec;
...
import org.seaboxdata.systemmng.bean.RepositoryCheckNode;
import org.seaboxdata.systemmng.bean.RepositoryNode;
import org.seaboxdata.systemmng.bean.RepositoryNodeType;
...
public class RepositoryController {
	...
	protected void createTrans(HttpServletResponse response,HttpServletRequest request,@RequestParam String dir, @RequestParam String transName,@RequestParam String[] taskGroupArray) throws KettleException, IOException {
		...
		try {
			...
			transMeta.setCreatedUser(userId);
