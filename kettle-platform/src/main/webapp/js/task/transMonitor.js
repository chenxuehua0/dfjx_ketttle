...
function  transCompositionImg(){
    ...
    var transId=grid.getSelectionModel().getSelected().get("transformationId");
    var transName=grid.getSelectionModel().getSelected().get("name");//被选中的任务路径
    
    var imgSrc=GetUrl('task/getTransImage.do?transId='+transId);
    var htmlInfo='<div style="height:470px;width:770px;overflow:auto;"><img src="'+imgSrc+'"></div>';
    var transImgWindow=new Ext.Window({
        id:"transImgWindow",
        title:transName,
